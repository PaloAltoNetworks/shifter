    ...
    with conn.cursor() as cur:
        cur.execute(
            ...
            SELECT
                ...
                victim_ip, victim_instance_id, victim_ssh_key_secret_arn,
                kali_ip, kali_instance_id, kali_ssh_key_secret_arn,
        ...
        return {
            ...
            "victim_ssh_key_secret_arn": row[9],
            "kali_ip": row[10],
            "kali_instance_id": row[11],
            "kali_ssh_key_secret_arn": row[12],
            "chat_url": row[13],
            "error_message": row[14],
            "created_at": row[15],
            "ready_at": row[16],
            "destroyed_at": row[17],
            "step_function_execution_arn": row[18],
        }
