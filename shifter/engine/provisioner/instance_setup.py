...
def _run_dc_setup(
    ...
    # on first boot before SSM agent is reliably online. 1800s gives plenty
    # of headroom for any sysprep variation; on a normal already-warm DC
    # AMI the wait returns in seconds anyway.
