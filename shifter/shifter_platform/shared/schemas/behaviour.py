"""Behaviour schemas for CMS data contracts.
...
# There is currently one behaviour projection. A discriminator only becomes
# valid once this alias has at least two tagged variants.
BehaviourContext = AttackBehaviourContext
