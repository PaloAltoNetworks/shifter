...
An isolated demo environment. Contains attacker machines and victim machines in a private network. Each range is independent - your attacks don't affect other users.
