"""Read-projection (redaction) tests for ACES participant history/evidence records (#1289)."""
...
_CONTRACT_VERSION = {
    AcesParticipantRuntimeRecord.RecordKind.PARTICIPANT_BEHAVIOR_HISTORY: "participant-behavior-history-v1",
    AcesParticipantRuntimeRecord.RecordKind.PARTICIPANT_EVIDENCE: "participant-evidence-v1",
}
