...
|-----------|--------|---------|
| **Global** | `terraform/global/iam/` | GitHub OIDC provider, CI/CD IAM roles |
| **Core** | `terraform/environments/{env}/` | ECR repositories, budget alerts |
| **Range** | `terraform/modules/range/` | Range VPC, security groups, Network Firewall |
| **Portal*** | `terraform/modules/portal/` | ALB, EC2/ASG, RDS, Redis, Cognito, S3 |
| **Pulumi Provisioner** | `terraform/modules/pulumi-provisioner/` | ECS Fargate task for range provisioning |
