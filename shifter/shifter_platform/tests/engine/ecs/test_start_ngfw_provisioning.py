...
class TestStartNgfwProvisioning:
    ...
    - Side effects: Calls _start_ngfw_ecs_task with provision command
    ...
    def test_raises_type_error_when_request_id_is_string(self, settings):
        ...
        with pytest.raises(TypeError):
            start_ngfw_provisioning(request_id=str(TEST_REQUEST_ID))
    ...
    def test_raises_type_error_when_request_id_is_int(self, settings):
        ...
        with pytest.raises(TypeError):
            start_ngfw_provisioning(request_id=42)
