...
from engine.provisioner.orchestrators.setup_orchestrator import SetupOrchestrator
from engine.provisioner.plans.ngfw_provision import NGFWProvisionPlan
from engine.provisioner.terraform import base_runner as terraform_runner
...
def run_ngfw_terraform(operation: str, request_id: str) -> None:
    ...
    from engine.provisioner.main import (
...
def _run_provision(
    ...
    from engine.provisioner.main import poll_for_serial_number
    ...
    from engine.provisioner.main import run_ngfw_operation
...
def _run_deprovision(
    ...
    from engine.provisioner.main import get_ngfw_data_by_request_id, update_instance_state
