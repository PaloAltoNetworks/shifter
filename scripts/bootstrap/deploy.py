    ...
    *,
    ...
    lines = [
        ...
        *_sample_guest_access_defaults(),
        "# Per-guest sizing only. VM Runtime image URLs are fetched live from",
        "# Secret Manager (shifter-<env>-range-image-<kali|ubuntu|windows|dc>).",
        "GDC_KALI_VCPUS=2",
        "GDC_KALI_MEMORY=4Gi",
        ...
        "# Lower-fidelity scenario Pod assets must use explicitly curated",
        "# container images. No Docker Hub defaults are shipped here.",
