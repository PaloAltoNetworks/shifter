...
- [ ] Existing AuditLog records unaffected
- [ ] All new choices validate correctly
- [ ] Admin displays new fields
...
- [ ] X-Forwarded-For parsing handles ALB format
- [ ] API key authentication detected correctly
...
**Acceptance Criteria**:
- [ ] Every `create_range()` call produces AuditLog
- [ ] Scenario and configuration captured in new_state
- [ ] User who requested range is actor
...
**Acceptance Criteria**:
- [ ] User-initiated destruction logged with user as actor
- [ ] System-initiated cleanup logged with system as actor
- [ ] Range ID and status captured
...
**Acceptance Criteria**:
- [ ] All credential creations logged
- [ ] Credential type and name captured
- [ ] No secrets in audit log
- [ ] User who created is actor
...
**Acceptance Criteria**:
- [ ] All credential deletions logged
- [ ] Previous credential metadata captured
- [ ] User who deleted is actor
...
**Acceptance Criteria**:
- [ ] Agent create uses AuditLog
- [ ] Agent delete uses AuditLog
- [ ] ActivityLog imports removed from cms/assets
- [ ] ActivityLog marked deprecated
...
**Acceptance Criteria**:
- [ ] NGFW provisioning logged
- [ ] NGFW destruction logged
- [ ] Associated range ID captured
...
|----------|-------|-------|
| P0 | 3 | Foundation (schema, service, admin) |
| P1 | 7 | Auth events, range lifecycle, credentials |
| P2 | 5 | Sessions, agents, NGFW, users, API |
