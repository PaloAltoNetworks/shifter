...
BUILD_TARBALL_S3_URI="${BUILD_TARBALL_S3_URI:?Set BUILD_TARBALL_S3_URI to your polaris build tarball, e.g. s3://shifter-polaris-bake-dev-<account-id>/polaris/build-aws-dev-default-vpc.tar.gz}"
