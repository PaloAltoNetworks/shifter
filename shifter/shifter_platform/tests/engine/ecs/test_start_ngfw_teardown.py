...
class TestStartNgfwTeardown:
    ...
    - Side effects: Calls _validate_ngfw_id, then _start_ngfw_ecs_task with deprovision command
    ...
    def test_returns_task_arn_on_success(self, settings):
        ...
        with patch("engine.ecs._get_ecs_client") as mock_get_client:
            ...
            result = start_ngfw_teardown(ngfw_id=42)
    ...
    def test_calls_start_ngfw_ecs_task_with_deprovision_command(self, settings):
        ...
        with patch("engine.ecs._start_ngfw_ecs_task") as mock_start:
            ...
            mock_start.assert_called_once_with(42, ["ngfw", "deprovision", "--user-ngfw-id", "42"])
    ...
    def test_command_includes_ngfw_id_as_string(self, settings):
        ...
        with patch("engine.ecs._start_ngfw_ecs_task") as mock_start:
            ...
            start_ngfw_teardown(ngfw_id=999)

            call_args = mock_start.call_args
            command = call_args[0][1]
            assert "999" in command
            assert command == ["ngfw", "deprovision", "--user-ngfw-id", "999"]
    ...
    def test_accepts_zero_as_ngfw_id(self, settings):
        ...
        with patch("engine.ecs._start_ngfw_ecs_task") as mock_start:
            ...
            result = start_ngfw_teardown(ngfw_id=0)

            assert result == "arn:aws:ecs:task/123"
            mock_start.assert_called_once_with(0, ["ngfw", "deprovision", "--user-ngfw-id", "0"])
    ...
    def test_accepts_large_ngfw_id(self, settings):
        ...
        with patch("engine.ecs._start_ngfw_ecs_task") as mock_start:
            ...
            result = start_ngfw_teardown(ngfw_id=999999999)
    ...
    def test_raises_type_error_when_ngfw_id_is_none(self, settings):
        ...
        with pytest.raises(TypeError):
            start_ngfw_teardown(ngfw_id=None)
    ...
    def test_raises_type_error_when_ngfw_id_is_float(self, settings):
        ...
        with pytest.raises(TypeError):
            start_ngfw_teardown(ngfw_id=42.0)
    ...
    def test_raises_type_error_when_ngfw_id_is_bool(self, settings):
        ...
        with pytest.raises(TypeError):
            start_ngfw_teardown(ngfw_id=True)
    ...
    def test_raises_type_error_when_ngfw_id_is_dict(self, settings):
        ...
        with pytest.raises(TypeError):
            start_ngfw_teardown(ngfw_id={"id": 42})
    ...
    def test_boundary_one_succeeds(self, settings):
        ...
        with patch("engine.ecs._start_ngfw_ecs_task") as mock_start:
            ...
            result = start_ngfw_teardown(ngfw_id=1)
    ...
    def test_uses_deprovision_not_provision(self, settings):
        ...
        with patch("engine.ecs._start_ngfw_ecs_task") as mock_start:
            ...
            assert "provision" not in command or command[1] == "deprovision"
