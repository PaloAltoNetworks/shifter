...
output "openwebui_ecr_url" {
  description = "ECR repository URL for custom OpenWebUI"
  value       = module.openwebui_ecr.repository_url
}

output "openwebui_ecr_arn" {
  description = "ECR repository ARN for custom OpenWebUI"
  value       = module.openwebui_ecr.repository_arn
}
