"""Tests for the RAES read-projection seam (#1275).

Drives real ``RaesOperationRecord`` rows through ``list_operation_records`` and
...
class TestListOperationRecords:
    def test_redacts_persisted_but_non_response_keys(self):
        ...
        [proj] = list_operation_records(request_id, RaesOperationRecord.RecordKind.OPERATION_STATUS)
    ...
    def test_runtime_snapshot_response_allowlist_strips_non_returned_keys(self):
        ...
        [proj] = list_operation_records(request_id, RaesOperationRecord.RecordKind.RUNTIME_SNAPSHOT)
    ...
    def test_orders_newest_first(self):
        ...
        projections = list_operation_records(request_id, RaesOperationRecord.RecordKind.OPERATION_STATUS)
    ...
    def test_limit_is_clamped_to_max(self):
        ...
        results = list_operation_records(request_id, RaesOperationRecord.RecordKind.OPERATION_STATUS, limit=10_000)
    ...
    def test_default_limit_applied(self):
        ...
        results = list_operation_records(request_id, RaesOperationRecord.RecordKind.OPERATION_STATUS)
    ...
    def test_empty_when_no_rows(self):
        assert list_operation_records(uuid4(), RaesOperationRecord.RecordKind.RUNTIME_SNAPSHOT) == []
