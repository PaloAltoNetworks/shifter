"""PowerShell script templates for Windows ACES source-backed content delivery.

Extracted from ``aces_content_delivery.py`` (Sonar S104). These are the
guest-side deliver/verify script bodies :class:`AcesContentDeliveryPlan`
