...
from experiments.handlers import _parse_message, process_event
...
class ProcessEventTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="handler_user", password="test", is_staff=True)
    ...
    def test_experiment_start_schedules_runs(self):
        exp = Experiment.objects.create(
            user=self.user, name="Start Handler", scenario_id="basic",
    ...
    def test_run_failed_event(self):
        exp = Experiment.objects.create(
            user=self.user, name="Fail Handler", scenario_id="basic",
