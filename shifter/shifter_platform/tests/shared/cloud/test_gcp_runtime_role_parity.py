...
``installation.runtime_inventory.GCP_PROVISIONER_FORWARDED_RUNTIME_ENV_KEYS`` declares which
...
def test_forwarded_manifest_matches_task_runner_intersected_with_generated_keys() -> None:
    ...
    assert expected == GCP_PROVISIONER_FORWARDED_RUNTIME_ENV_KEYS, (
        "installation.runtime_inventory.GCP_PROVISIONER_FORWARDED_RUNTIME_ENV_KEYS has drifted from "
