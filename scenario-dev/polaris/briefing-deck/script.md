...
*Let the terminal decode animation play. Don't talk over it. ~10s.*
...
*Let the closing animation finish. Brief pause.*

> That's your briefing. Start Here is open on CTFd — go solve the warm-up. Mission One is live.
>
...
If you want to close the briefing with something practical before they scatter:

- "CTFd is your scoreboard and your reference — everything you need to know about a mission is in its description."
- "Your Kali box opens from the magic link in your email. Keep that tab open alongside CTFd."
- "Ask questions in the room. Ask Claude on your box. Try things."
- Pause, then: "Clock starts now."
