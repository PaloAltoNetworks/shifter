...
- GCP corporate users authenticate in the browser through the Identity Platform SDK flow. Django only accepts verified Google identity tokens and creates the application session after email-verification and MFA checks pass.
