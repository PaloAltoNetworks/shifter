"""Tests for shared.script_context — execution-layer sanitization boundary.
...
class TestInstanceIdValue:
    ...
    def test_accepts_valid_instance_ids(self, value: str) -> None:
        from shared.script_context import InstanceValues
...
class TestPrivateIpValue:
    ...
    @pytest.mark.parametrize(
        "value",
        ["10.0.0.1", "192.168.1.1", "172.16.42.42", "0.0.0.0", "255.255.255.255"],  # noqa: S104
    )
...
class TestPromptText:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "Multi\nline\nprompt",
            "Has 'quotes' and \"double\" and `backticks`",
