...
from shared.channels import groups
from shared.enums import ResourceStatus
from shared.schemas.range import AgentDetails, InstanceSpec, RangeSpec
...
class TestWireSpecKeysAlignWithSchemas:
    def test_range_spec_schema_keys_are_model_fields(self) -> None:
        assert set(RangeSpec.model_fields) >= spec_keys.RANGE_SPEC_TOP_LEVEL_SCHEMA_KEYS

    def test_subnet_schema_keys_are_model_fields(self) -> None:
        assert set(SubnetSpec.model_fields) >= spec_keys.SUBNET_SCHEMA_KEYS

    def test_instance_schema_keys_are_model_fields(self) -> None:
        assert set(InstanceSpec.model_fields) >= spec_keys.INSTANCE_SCHEMA_KEYS

    def test_agent_schema_keys_are_model_fields(self) -> None:
        assert set(AgentDetails.model_fields) >= spec_keys.AGENT_SCHEMA_KEYS
