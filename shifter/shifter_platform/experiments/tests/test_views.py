...
from experiments.schemas import ExperimentStatus, RunStatus
...
class StaffAccessTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="view_user", password="test", is_staff=False)
        cls.staff = User.objects.create_user(username="view_staff", password="test", is_staff=True)

    def test_experiment_list_requires_staff(self):
        self.client.login(username="view_user", password="test")
    ...
    def test_experiment_list_staff_ok(self):
        self.client.login(username="view_staff", password="test")
        resp = self.client.get(reverse("experiments:experiment_list"))
...
class ExperimentListViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="list_view_user", password="test", is_staff=True)
        cls.other = User.objects.create_user(username="list_other", password="test", is_staff=True)
        cls.exp = Experiment.objects.create(
            user=cls.user, name="My Experiment", scenario_id="basic",
        )
        Experiment.objects.create(
            user=cls.other, name="Other Experiment", scenario_id="basic",
        )

    def test_shows_own_experiments(self):
        self.client.login(username="list_view_user", password="test")
        resp = self.client.get(reverse("experiments:experiment_list"))
        assert resp.status_code == 200
...
class ExperimentDetailViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="detail_user", password="test", is_staff=True)
        cls.other = User.objects.create_user(username="detail_other", password="test", is_staff=True)
        cls.exp = Experiment.objects.create(
            user=cls.user, name="Detail Test", scenario_id="basic",
            total_runs=3,
        )
        for i in range(1, 4):
    ...
    def test_detail_shows_experiment(self):
        self.client.login(username="detail_user", password="test")
    ...
    def test_detail_other_user_redirects(self):
        self.client.login(username="detail_other", password="test")
        resp = self.client.get(reverse("experiments:experiment_detail", args=[self.exp.pk]))
...
class ExperimentStartViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="start_view_user", password="test", is_staff=True)
    ...
    def test_start_draft_experiment(self):
        ...
        self.client.login(username="start_view_user", password="test")
    ...
    def test_start_requires_post(self):
        exp = Experiment.objects.create(
            user=self.user, name="Start GET", scenario_id="basic",
        )
        self.client.login(username="start_view_user", password="test")
...
class ExperimentCancelViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="cancel_view_user", password="test", is_staff=True)
    ...
    def test_cancel_queued_experiment(self):
        ...
        self.client.login(username="cancel_view_user", password="test")
    ...
    def test_cancel_requires_post(self):
        exp = Experiment.objects.create(
            user=self.user, name="Cancel GET", scenario_id="basic",
        )
        self.client.login(username="cancel_view_user", password="test")
...
class ExperimentCreateViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="create_view_user", password="test", is_staff=True)

    def test_create_get_renders_form(self):
        self.client.login(username="create_view_user", password="test")
    ...
    def test_create_post_valid(self):
        self.client.login(username="create_view_user", password="test")
        resp = self.client.post(reverse("experiments:experiment_create"), {
            "name": "View Test Exp",
            "scenario_id": "basic",
            "total_runs": "2",
            "max_parallel_runs": "1",
...
class ScenarioInstancesViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = User.objects.create_user(username="scenario_view_user", password="test", is_staff=True)

    def test_returns_instances(self):
        self.client.login(username="scenario_view_user", password="test")
